...
public class OnSwipeTouchListener implements View.OnTouchListener {
    ...
    private static List< PendingSwipeData > mPendingSwipes = new ArrayList< PendingSwipeData >();
     ...
     */
    public OnSwipeTouchListener(ListView listView, OnSwipeCallback callback) {
     ...
     */
    public OnSwipeTouchListener(ListView listView, OnSwipeCallback callback, boolean dismissLeft, boolean dismissRight) {
    ...
    private void performSwipeAction(final View swipeView, final int swipePosition, boolean toTheRight, boolean dismiss) {
        ...
        final ViewGroup.LayoutParams lp = swipeView.getLayoutParams();
         originalHeight = swipeView.getHeight();
